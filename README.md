# bci_project
My solution for "web application API which primary function is to serve as a platform for selling and buying used item" graded exercise. Course Building Cloud Integration, spring 2021.
